    ...
    <div className={`py-4 min-h-screen ${styles.section}`}>
          ...
          <div className="w-full flex items-start mb-5" key={index}>
            ...
            <div className="w-full">
              ...
              <h5 className="pl-3 text-[20px] text-[#00000091]">
               {priceFormat.format(item.discountPrice) } x {item.qty}
              </h5>
            </div>
          </div>
        ))}
      ...
      <div className="border-t w-full text-right">
        <h5 className="pt-3 text-[18px]">
                  Total Price: <strong>{priceFormat.format(data?.totalPrice) }</strong>
        </h5>
      </div>
      <br />
      <br />
      <div className="w-full 800px:flex items-center">
        <div className="w-full 800px:w-[60%]">
          ...
          <h4 className=" text-[20px]">State: {data?.shippingAddress.state}</h4>
          <h4 className=" text-[20px]">City: {data?.shippingAddress.city}</h4>
          <h4 className=" text-[20px]">Phone No.:{data?.user?.phoneNumber}</h4>
        </div>
