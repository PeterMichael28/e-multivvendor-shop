...
const ShopProfileData = ({ isOwner }) => {
  ...
  const { getAllEventsShop,  shopEvents } = useEventStore(
    (state) => ({getAllEventsShop: state.getAllEventsShop, shopEvents:state.shopEvents}),
    shallow
  )
  ...
  useEffect(() => {
    ...
    getAllEventsShop(id)
  }, [getAllProductsShop,getAllEventsShop, id]);
