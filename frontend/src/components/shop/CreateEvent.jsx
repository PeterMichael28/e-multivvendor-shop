...
const CreateEvent = () => {
    ...
    const { loadEventsSuccess,  loadEventsFail, event } = useEventStore(
      (state) => ({loadEventsSuccess: state.loadEventsSuccess, loadEventsFail:state.loadEventsFail, event:state.event}),
      shallow
    )
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Finish_Date: endDate?.toISOString(),
        ...
        await loadEventsSuccess(data.event)
        setLoading(false)
        toast.success("Event created successfully!");
        navigate("/dashboard-events");
      } catch (error) {
        await loadEventsFail(error.response.data.message)
