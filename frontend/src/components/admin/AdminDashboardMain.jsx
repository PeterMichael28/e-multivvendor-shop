...
const AdminDashboardMain = () => {
  ...
  const { allSellers, getAllSellers } = useSellersStore(
    ( state ) => ( { allSellers: state.allSellers, getAllSellers: state.getAllSellers} ),
    shallow
  )
      ...
      loading ? (
        ...
        <div className="w-full block 800px:flex items-center justify-between">
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <h5 className="pt-2 pl-[36px] text-[22px] font-[500]"> {priceFormat.format(adminBalance)}</h5>
          </div>
          ...
          <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
            ...
            <h5 className="pt-2 pl-[36px] text-[22px] font-[500]">{allSellers && allSellers.length}</h5>
